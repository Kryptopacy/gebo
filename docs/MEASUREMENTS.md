...
> **Census measured at 2026-08-30 15:32:01 UTC.**
...
```
  319,511   identities minted
  319,511   censused                        100.00% of the registry
  241,356   registration file resolved      75.54% of censused
  241,348   carry a name                    100.00% of resolved
  236,520   self-declare "active": true     98.00% of resolved
   83,821   declare ANY service endpoint    34.73% of resolved
    2,929   callable and lint-clean         1.21% of resolved
```

> **152,699 identities declare themselves active while publishing no endpoint of any
> kind.** `"active": true` is self-reported, unverified, and asserted by
> 98.00% of resolved registrations against 34.73% that
...
`data:` pointers resolve from calldata with no network call. `10,408`
...
| --- | --- | --- | --- |
| Distinct owners | **263,594** | Distinct endpoint operators | **107** |
| Holding exactly one | 243,511 | Largest operator's share | **80.56%** |
| Top 10 owners combined | 6.30% | Top 5 operators | 98.70% |
| Mean per owner | 1.2 | Top 20 operators | 99.76% |

> **263,594 wallets registered an identity. 107 organisations run
...
> present 263,594 apparently independent suppliers.
...
| | |
| --- | --- |
| Probes recorded | 139,261 |
| Distinct endpoints probed | 1,432 |
| Completed a protocol handshake | 135,494 |
