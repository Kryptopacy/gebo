...
> **Census measured at 2026-09-06 16:04:01 UTC.**
...
```
  337,179   identities minted
  337,179   censused                        100.00% of the registry
  255,712   registration file resolved      75.84% of censused
  255,704   carry a name                    100.00% of resolved
  250,630   self-declare "active": true     98.01% of resolved
   97,018   declare ANY service endpoint    37.94% of resolved
    3,178   callable and lint-clean         1.24% of resolved
```

> **153,612 identities declare themselves active while publishing no endpoint of any
> kind.** `"active": true` is self-reported, unverified, and asserted by
> 98.01% of resolved registrations against 37.94% that
...
`data:` pointers resolve from calldata with no network call. `10,572`
...
| --- | --- | --- | --- |
| Distinct owners | **272,941** | Distinct endpoint operators | **115** |
| Holding exactly one | 249,169 | Largest operator's share | **77.05%** |
| Top 10 owners combined | 5.97% | Top 5 operators | 98.83% |
| Mean per owner | 1.2 | Top 20 operators | 99.75% |

> **272,941 wallets registered an identity. 115 organisations run
...
> present 272,941 apparently independent suppliers.

| Operator | Agents | Verified | Fatal defects |
| --- | --- | --- | --- |
| `evoevo.ai` | 39,101 | 0 | 0 |
| `termix.live` | 16,924 | 0 | 16,924 |
| `quackai.ai` | 740 | 0 | 0 |
| `ensoul.ac` | 323 | 0 | 0 |
| `singularry.org` | 240 | 236 | 0 |
| `bitagent.io` | 238 | 0 | 0 |
| `bortagent.xyz` | 212 | 148 | 0 |
...
| | |
| --- | --- |
| Probes recorded | 230,237 |
| Distinct endpoints probed | 3,412 |
| Completed a protocol handshake | 222,597 |
| Agents `DORMANT` | 44,000 |
| Agents `SHADOWED` | 16,958 |
| Agents `VERIFIED` | 485 |
| Agents `LISTED` | 36 |
...
6,347 agents classified across 9 categories,
127 of them verified.

| Category | Required | Agents | Verified |
| --- | --- | --- | --- |
| rebalancing | **yes** | 79 | 6 |
| grid | **yes** | 24 | 4 |
| health | **yes** | 23 | 3 |
| yield | **yes** | 17 | 2 |
| trading | no | 2,865 | 75 |
...
Only **143** agents in the registry verifiably do one of the four
