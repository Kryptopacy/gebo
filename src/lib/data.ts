...
// The offline snapshot below is GENERATED by scripts/write-measurements.ts on
// the same daily schedule as the measurements doc, so the no-database demo
// mode cannot serve figures that quietly rot (found 11 days stale on
// 2026-08-30). It loads only when DATABASE_URL is absent or unreadable, and
// then renders with live=false - the "could not be measured" banner - so its
...
export const CENSUS_FALLBACK = {
  ...
  operators: 107,
  owners: 263_594,
  ownersWithOneAgent: 243_511,
  largestOperatorShare: 80.56,
  top5OperatorShare: 98.7,
  top10OwnerShare: 6.3,
  declaresReputationTrust: 150_746,
  emptyTokenUri: 10_408,
  x402Supported: 13_790,
  fatalDefects: 12_238,
  uriSchemes: { data: 157_214, https: 145_454, empty: 10_408, other: 5_099, ipfs: 1_327, http: 9 } as Record<string, number>,
  endpointKinds: { web: 20_322, a2a: 956, mcp: 381 } as Record<string, number>,
