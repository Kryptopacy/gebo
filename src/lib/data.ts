...
export const CENSUS_FALLBACK = {
  ...
  operators: 115,
  owners: 272_514,
  ownersWithOneAgent: 248_801,
  largestOperatorShare: 77.06,
  top5OperatorShare: 98.83,
  top10OwnerShare: 5.98,
  declaresReputationTrust: 152_052,
  emptyTokenUri: 10_554,
  x402Supported: 13_792,
  fatalDefects: 17_870,
  uriSchemes: { https: 161_367, data: 158_321, empty: 10_554, other: 5_099, ipfs: 1_327, http: 9 } as Record<string, number>,
